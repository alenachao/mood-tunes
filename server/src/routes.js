...
router.post('/login', async (req, res) => {
    ...
    */
    ...
    // interested in display_name, id, href, images, type
    console.log(req)
    ...
    if (!userExists) {
        ...
        await addUserToDatabase({spotifyID, username, apiEndpoint, profilePicture, accountType});
        ...
        res.json({ message: 'User found in the database.', previousSongs });
    }
    });
